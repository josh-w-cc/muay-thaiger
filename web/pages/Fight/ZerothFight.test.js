...
const {fighter} = vi.hoisted(() => ({
  fighter: {gold: 0n, spend: vi.fn(), stamina: 1n, strength: 1n},
}));
...
describe('ZerothFight', () => {
  beforeEach(() => {
    Object.assign(fighter, {gold: 0n, stamina: 1n, strength: 1n});
  });
  ...
  it('requires zeroth fight when stats or gold are too low', () => {
    expect(needsZerothFight({gold: 99n, stamina: 1n, strength: 1n})).toBe(true);
    expect(needsZerothFight({gold: 100n, stamina: 0n, strength: 1n})).toBe(true);
    expect(needsZerothFight({gold: 100n, stamina: 1n, strength: 0n})).toBe(true);
    expect(needsZerothFight({gold: 100n, stamina: 1n, strength: 1n})).toBe(false);
  });
  ...
  it('spends all gold and shows the strength branch message', () => {
    Object.assign(fighter, {gold: 150n, stamina: 1n});
    render(<ZerothFight />);
  ...
  it('shows the stanima branch message when stamina is missing', () => {
    Object.assign(fighter, {gold: 150n, stamina: 0n});
    render(<ZerothFight />);
