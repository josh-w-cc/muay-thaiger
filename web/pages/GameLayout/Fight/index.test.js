...
describe('Fight', () => {
  ...
  it('wraps fight content in a section', () => {
    ...
    expect(within(glorySection).getByRole('progressbar', {name: 'Tiger fighter stanima'})).toBeInTheDocument();
    expect(within(glorySection).getByRole('progressbar', {name: 'Snow leopard fighter stanima'})).toBeInTheDocument();
